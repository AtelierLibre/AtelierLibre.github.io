...
/**
 * Creates THREE js mesh from coordinates and material.
 * @param {*} coordinateJSTS 
 * @param {*} geometry3js 
 * @param {*} material3js 
 * @returns 
 */
export function coordinateToSphereMesh(coordinateJSTS, geometry3js, material3js) {
  const coordinates = coordinateJSTS;
