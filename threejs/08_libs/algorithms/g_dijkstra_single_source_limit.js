 ...
 */
export function* g_dijkstra_single_source_limit(graph, startID, costName, costLimit, uTurnPenalty) {
    ...
    while (pq.values.length > 0) {
        ...
        for (let [neighbourID, costs] of Object.entries(graph.links[current.val])) {
            ...
            let updatedCost = totalCosts[current.val] + graph.links[current.val][neighbourID][costName];
