...
export function dijkstra_single_source_limit(graph, start_id, limit) {
    ...
    while (pq.values.length > 0) {
        ...
        for (let neighbour_id of graph.vertices[current.val]['neighbours']) {
            ...
            let distance = distances[current.val] + graph.vertices[current.val]['neighbours_metric'][neighbour_id];
